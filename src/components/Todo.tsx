			...
			<div className="flex items-center">
				<input
					className="checkBox | mr-3 peer appearance-none h-6 w-6 border
								dark:border-gray-600 border-gray-300 hover:dark:border-gray-400 hover:border-gray-600 rounded-full checked:border-none focus:outline-none transition duration-200
								 cursor-pointer"
					type="checkbox"
					id={`${todo.id}`}
				...
				/>
				<label
					className="dark:text-lightBlue200 peer-checked:line-through peer-checked:text-gray-400 dark:peer-checked:text-gray-500 select-none"
					htmlFor={`${todo.id}`}
				>
					{todo.title}
				</label>
